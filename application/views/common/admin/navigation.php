...
<section class="navbar-side">
   <ul class="nav crunchy-navigation sidebar-menu">
     ...
     <li>
      ...
      <li>
         <a <?php if(isset($activemenu) && $activemenu=='publication') echo 'class="active-menu"';?> href="<?php echo base_url('publication/') ;?>">
         	<i class="fa fa-newspaper-o fa-3x" aria-hidden="true"></i>Publicaciones</a>
      </li>
	  <!--CUSTOMERS-->
      ...
      <li> 
         ...
         <ul class="sidebar-submenu">
            ...
            <li style="display: block"><a <?php if(isset($actv_submenu) && $actv_submenu=='date_wise') echo 'class="active-menu"';?> href="<?php echo URL_REPORTS_INDEX;?>"> <?php echo get_languageword('date_wise_reports');?> </a></li>
			
            <!-- <li style="display: block"><a <?php //if(isset($actv_submenu) && $actv_submenu=='customer_wise') echo 'class="active-menu"';?> href="<?php //echo URL_REPORTS_CLIENT_WISE;?>"> <?php //echo get_languageword('customer_wise_reports');?> </a></li> -->
			
			<li style="display: block"><a <?php if(isset($actv_submenu) && $actv_submenu=='location_wise') echo 'class="active-menu"';?> href="<?php echo URL_REPORTS_LOCATION_WISE;?>"> <?php echo get_languageword('location_wise_reports');?> </a></li>
			
			<li style="display: block"><a <?php if(isset($actv_submenu) && $actv_submenu=='item_wise') echo 'class="active-menu"';?> href="<?php echo URL_REPORTS_ITEM_WISE;?>"> <?php echo get_languageword('item_wise_reports');?> </a></li>
         </ul>
      </li>
	  <!--Reports-->
	 <!--Master Settings-->  
      <li>
         ...
         <ul class="sidebar-submenu">
            <li style="display: block"><a <?php if(isset($actv_submenu) && $actv_submenu=='paypal_settings') echo 'class="active-menu"';?> href="<?php echo URL_PAYPAL_SETTINGS;?>"> <?php echo get_languageword('paypal_settings');?> </a></li>
			...
			<li style="display: none"><a <?php if(isset($actv_submenu) && $actv_submenu=='sms_gateways') echo 'class="active-menu"';?> href="<?php echo URL_SMS_GATEWAYS;?>"> <?php echo get_languageword('sms_gateways');?> </a></li>
			
			<li style="display: none"><a <?php if(isset($actv_submenu) && $actv_submenu=='sms_templates') echo 'class="active-menu"';?> href="<?php echo URL_SMS_TEMPLATES;?>"> <?php echo get_languageword('sms_templates');?> </a></li>
			...
			<li style="display: none"><a <?php if(isset($actv_submenu) && $actv_submenu=='pusher_notification') echo 'class="active-menu"';?> href="<?php echo URL_PUSHER_NOTIFICATION_SETTINGS;?>"> <?php echo get_languageword('pusher_notification_settings');?> </a></li>
			...
			<li style="display: none"><a <?php if(isset($actv_submenu) && $actv_submenu=='tinify_settings') echo 'class="active-menu"';?> href="<?php echo URL_TINIFY_SETTINGS;?>"> <?php echo get_languageword('tinify_settings');?> </a></li>
