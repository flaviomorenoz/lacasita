...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/css/font-pizzaro.css" media="all" />
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/css/style.css" media="all" />
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/css/colors/red.css" media="all" />
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/css/jquery.mCustomScrollbar.min.css" media="all" />
               ...
               <nav id="site-navigation" class="main-navigation" aria-label="Primary Navigation">
                  ...
                  <div class="handheld-navigation">
		                ...
		                <ul  class="menu">
                        	...
                        	<li class="menu-item"><a href="<?php echo URL_ABOUT_US;?>"><?php echo get_languageword('about_us');?></a></li>
                        	<li class="menu-item"><a href="<?php echo URL_CONTACT_US;?>"><?php echo get_languageword('contact_us');?></a></li>
                        	<li class="mini_cart_item"><a href="<?php echo URL_AUTH_LOGOUT;?>"><?php echo get_languageword('logout');?></a></li>
		                </ul>
                  </div>
               </nav>
