					 ...
					 <?php foreach($addresses as $address) :?>
                      <div class="col-md-6 col-lg-4">
						   ...
						   <?php } ?>
                            ...
                            <p> <?php echo $address->street;?> <?php echo $address->house_no;?></p>
               ...
               <div class="login-block-header text-center"><?php echo get_languageword('add_address');?></div>
				...
				<?php //echo $this->session->flashdata('message'); ?>
					...
					<?php 
					 ...
					 echo form_dropdown('city_id',$cities,$val,'class="form-control form-control-lg chzn-select" id="city_id" onchange="get_localities()"');	
					 ?>
                    </div>
					...
					echo form_dropdown('locality','',$val,'class="form-control form-control-lg chzn-select" id="locality" placeholder="Distrito" onchange="get_pincode()"');
