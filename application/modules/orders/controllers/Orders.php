        ...
        if ($this->input->is_ajax_request()) {
            ...
            if (!empty($records)) {
                ...
                foreach ($records as $record) {
                    ...
                    $row[] = '<span class="'.$class.'">'.ucwords(str_replace("_", " ", $order_status)).'</span>';
                ...
                if ($this->base_model->update_operation($data, TBL_ORDERS, $where)) {
                    ...
                    if (!empty($email_template)) {
                        ...
                        if ($order->payment_type == 'cashCard') {
                            $cash = 'Pago contra entrega'.' - '. $order->payment_card;
                        }else{
                            $cash = 'Pago Online';
                        }
                        ...
                        $content         = str_replace("__STATUS__", $order_status, $content);
