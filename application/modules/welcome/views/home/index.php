...
?>
<div id="content" class="site-content" tabindex="-1" style="background-size:cover; background-position:center center; background-image:url( <?php echo get_home_page_img();?>); padding-top:480px">
   <div class="col-full">
                  ...
                  <main id="main" class="site-main">
                     <div class="tiles">
                        <div class="row">
                           ...
                           <div class="col-xs-12 col-sm-6">
                              <div class="section-store-search animate-in-view" data-animation="zoomIn" style="background-size: cover; background-position: center center; background-image: url( uploads/banner/default_search.jpg ); min-height: 210px;">
