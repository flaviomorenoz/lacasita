        	...
        	<div class="left-sidebox">
        		<div class="search cs-searchbox mb-2" >
          			<div class="search-innerwrapper">
              			<input type="text" id="search-inp" name="search-inp" placeholder="<?php echo get_languageword('search');?>" onkeyup="search_item();" class="form-control" >
              			<i class="pe-7s-search"></i>
		              	<div class="search-results"></div>
          			</div>
        		</div>
			   	<div id="nav_menu-2" class="widget widget_nav_menu" style="background-color: #f7f7f7; padding: 10px 0; border-radius: 3px;">
			    	<div class="menu-food-menu-container" id="get_category">
