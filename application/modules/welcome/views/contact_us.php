  	...
  	<div class="container">
		<div class="row">
			...
			<div class="col-md-4">
				...
				<p><i class="fa fa-fw fa-map-o" aria-hidden="true"></i> <?php echo $site_adres;?></p>
				<?php if ($this->config->item('site_settings')->land_line != ''): ?>
				<p>
					<i class="fa fa-fw fa-phone" aria-hidden="true"></i>
					Celular: <?php echo $this->config->item('site_settings')->land_line;?>
				</p>
				<?php endif ?>
				<?php if ($this->config->item('site_settings')->phone != ''): ?>
				<p>
					<i class="fa fa-fw fa-phone" aria-hidden="true"></i>
					Teléfono: <?php echo $this->config->item('site_settings')->phone;?> 
				</p>
				<?php endif ?>
				<?php if ($this->config->item('site_settings')->portal_email != ''): ?>
				<p>
					<i class="fa fa-fw fa-envelope-o" aria-hidden="true"></i>
					<?php echo $this->config->item('site_settings')->portal_email;?>
				</p>
				<?php endif ?>
