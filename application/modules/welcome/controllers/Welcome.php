        ...
        if ($this->input->is_ajax_request()) {
            ...
            if ($item_id > 0) {
                ...
                if (!empty($record)) {
					...
					<div class="col-sm-6">
					<a href="javascript:void(0);" onclick="addToCart()" class="btn btn-sm btn-round btn-primary card-btn">Añadir al Carrito</a>
					</div></div>';
                    ...
                    if (!empty($addons)) {
                        ...
                        $page .= '<div class="category-title">Complementos</div>
								<div class="menu-list">
								<div class="row">
								';
                    ...
                    if (!empty($options)) {
                        ...
                        $page .= '<div class="category-title">Opciones</div>
								<div class="menu-list">
								<div class="row">
								';
                        $o=0;
        ...
        if ($this->input->is_ajax_request()) {
            ...
            if ($item_id > 0 && !empty($this->cart->contents())) {
                ...
                if (!empty($record)) {
					...
					<div class="col-sm-6">
					<a href="javascript:void(0);" onclick="updateToCart()" class="btn btn-sm btn-round btn-primary card-btn">Actualizar al Carrito</a>
					</div></div>';
        ...
        if ($this->input->is_ajax_request()) {
            ...
            if ($offer_id > 0) {
                ...
                if (!empty($record)) {
					...
					<a href="javascript:void(0);" onclick="addOfferToCart()" class="btn btn-sm btn-round btn-primary card-btn">Añadir al Carrito</a>
					</div>';
                    ...
                    if (!empty($offer_products)) {
                        ...
                        $page .= '<div class="category-title">Artículo Ofertas</div>
								<div class="menu-list">';
