   ...
   <div class="row">
      ...
      <div class="col-md-3">
        ...
        <ul class="dash-menu">
          ...
          <li class="active"><a href="<?php echo URL_USER_MY_ORDERS;?>"><i class="pe pe-7s-box1"></i><?php echo get_languageword('my_orders');?></a></li>
				        		...
				        		<div class="col-sm-5">
				        			<div class="oh-details">
				        				...
				        				<ul class="ul">
				        					...
				        					<li><?php echo get_languageword('items_total');?>:<span><?php echo $currency_symbol;?><?php echo number_format($order->total_cost - $order->delivery_fee, 2);?></span></li>
				        					...
				        					<!--<li><?php // get_languageword('is_points_redeemed');?>: 0<span><?php //if(isset($order->is_points_redeemed)) echo $order->is_points_redeemed;?></span></li>-->
											
											
											<?php //if($order->is_points_redeemed=='Yes') {?>
											
											<!--<li><?php //echo get_languageword('no_of_points_redeemed');?>: 1<span><?php //if(isset($order->no_of_points_redeemed)) echo $order->no_of_points_redeemed;?></span></li>-->
											
											
											<!--<li><?php //echo get_languageword('points_value');?>: 2-->
				        					...
				        					<li><?php echo get_languageword('payment_mode');?>:
											...
											if ($order->payment_type=='cashCard'):
												$paytype='Pago contra entrega'.' - '.$order->payment_card;;
				        		...
				        		<div class="col-sm-5">
				        			<div class="oh-details">
										...
										<ul class="ul">
				        					...
				        					<li><?php echo get_languageword('booked_date');?>:
				        						<span>
				        						<?php if(isset($order->order_date) && $order->order_date != '') echo get_date($order->order_date);?> <?php if(isset($order->order_time) && $order->order_time != '') echo date("g:i A", strtotime( str_replace('PM', '', $order->order_time)));?>
				        						</span>
				        					</li>
											
											<li><?php echo get_languageword('delivered_date');?>:
												<span>
													<?php if(isset($order->delivered_status_datetime) && $order->delivered_status_datetime != '') 
													echo get_date($order->delivered_status_datetime).' '.date('g:i A', strtotime($order->delivered_status_datetime));?>
