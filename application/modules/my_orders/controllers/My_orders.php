        ...
        if ($this->ion_auth->logged_in()) {
            ...
            if (!empty($order)) {
                ...
                if (!empty($order_products)) {
                    ...
                    $p=0;
                    $page .= '<div class="modal-table"><table class="table table-striped table-sm table-bordered" style="font-size: 14px;">';
                
                    $page .= '<thead>
						  <tr>
						  <th>#</th>
						  <th style="text-align: center;">'.get_languageword('item_name').'</th>
						  <th style="text-align: center;">'.get_languageword('option').'</th>
						  <th style="text-align: center;">'.get_languageword('item_cost').'</th>
						  <th style="text-align: center;">'.get_languageword('quantity').'</th>
						  <th style="text-align: center;">'.get_languageword('total_cost').'</th>
						  </tr>
						  </thead> <tbody>';
                ...
                if (!empty($order_offers)) {
                    ...
                    $page .= '<thead>
						  <tr>
						  <th>#</th>
						  <th style="text-align: center;">'.get_languageword('offer_name').'</th>
						  <th style="text-align: center;">'.get_languageword('item_cost').'</th>
						  <th style="text-align: center;">'.get_languageword('quantity').'</th>
						  <th style="text-align: center;">'.get_languageword('total_cost').'</th>
						  <th style="text-align: center;">'.get_languageword('no_of_products').'</th>
						  </tr>
						  </thead> <tbody>';
                    $o=0;          
