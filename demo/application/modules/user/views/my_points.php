   ...
   <div class="row">
      ...
      <div class="col-md-9">
         <div class="cs-card cart-card card-show">
               <div class="card-header bordered card-header-lg">
               	<?php if (isset($pagetitle)) echo $pagetitle;?> <a  class="btn btn-outline-primary pull-right no-border"><i class="pe-7s-wallet"></i> <?php echo get_languageword('balance');?> : <?php if (isset($user_total_points)) echo $user_total_points;?> <?php echo get_languageword('points');?> </a></div>
                        ...
                        <h4 class="panel-title">
                            ...
                            <div class="order-history oh-points">
                                <h4 class="<?php echo $cls;?>"> 
                                	...
                                	<span> <?php if ($point->order_id>0) echo '(Order #: '.$point->order_id.')'; ?></span> 
                                	<span class="oh-price"> 
                                		<?php if ($point->transaction_type=='Earned') echo '+';else echo '-';?><?php echo $point->points;?>
                                	</span>
                                </h4>
